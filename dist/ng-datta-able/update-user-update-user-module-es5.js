...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["update-user-update-user-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppDemoUserUpdateUserUpdateUserComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppDemoUserUpdateUserUpdateUserRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "UpdateUserRoutingModule", function () {
    ...
    var _update_user_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    ...
    var UpdateUserRoutingModule = function UpdateUserRoutingModule() {
      _classCallCheck(this, UpdateUserRoutingModule);
    };

    UpdateUserRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppDemoUserUpdateUserUpdateUserComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppDemoUserUpdateUserUpdateUserComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    /*#__PURE__*/
    function () {
      function UpdateUserComponent(formBuilder, user, currentRoute) {
        ...
        this.uploadAPI = "".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].apiUrl, "/user/update/image");
      ...
      _createClass(UpdateUserComponent, [{
            ...
            _this.user.getUserById(params.id).then(function (response) {
              if (response['status'] === 200) {
                if (response['data'].length > 0) {
                  ...
                  _this.updateUserForm.controls['username'].setValue(_this.userProfile.username);

                  _this.updateUserForm.controls['email'].setValue(_this.userProfile.email);

                  _this.updateUserForm.controls['first_name'].setValue(_this.userProfile.first_name);

                  _this.updateUserForm.controls['last_name'].setValue(_this.userProfile.last_name);

                  _this.updateUserForm.controls['phone'].setValue(_this.userProfile.phone);

                  _this.updateUserForm.controls['image'].setValue(_this.userProfile.image);

                  _this.updateUserForm.controls['user_id'].setValue(_this.userProfile.id);
                }
              } else {
        ...
        value: function preview() {
          ...
          reader.onload = function (_event) {
            _this2.previewUrl = reader.result;
          };
        }
      }, {
        key: "onUpdateUserSubmit",
        value: function onUpdateUserSubmit() {
          var _this3 = this;

          if (!this.updateUserForm.invalid) {
            var data = this.updateUserForm.value;
            data['user_id'] = this.userProfile.id;
            this.user.update(data).then(function (updateResponse) {
              if (updateResponse['status'] === 200) {
                if (_this3.fileData) {
                  _this3.uploader.onBuildItemForm = function (fileItem, form) {
                    form.append('userId', updateResponse['user'].id);
                  };

                  _this3.uploader.uploadAll();

                  _this3.uploader.onSuccessItem = function (item, response, status, headers) {
                    if (response) {
                ...
                sweetalert2__WEBPACK_IMPORTED_MODULE_7___default.a.fire('Error', "".concat(updateResponse['message']), 'error');
              }
            });
          }
        }
    ...
    UpdateUserComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/demo/user/update-user/update-user.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./update-user.component.scss */
      "./src/app/demo/user/update-user/update-user.component.scss")).default]
    })], UpdateUserComponent);
    /***/
  },
  ...
  /***/
  function srcAppDemoUserUpdateUserUpdateUserModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "UpdateUserModule", function () {
    ...
    var _update_user_routing_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    ...
    var UpdateUserModule = function UpdateUserModule() {
      _classCallCheck(this, UpdateUserModule);
    };

    UpdateUserModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      declarations: [_update_user_component__WEBPACK_IMPORTED_MODULE_3__["UpdateUserComponent"]],
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _update_user_routing_module__WEBPACK_IMPORTED_MODULE_4__["UpdateUserRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["ReactiveFormsModule"], _theme_shared_shared_module__WEBPACK_IMPORTED_MODULE_6__["SharedModule"], ng2_file_upload__WEBPACK_IMPORTED_MODULE_7__["FileUploadModule"], _sweetalert2_ngx_sweetalert2__WEBPACK_IMPORTED_MODULE_8__["SweetAlert2Module"]]
    })], UpdateUserModule);
    /***/
  }
}]);
//# sourceMappingURL=update-user-update-user-module-es5.js.map