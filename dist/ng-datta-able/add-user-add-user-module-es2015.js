...
/* harmony import */ var _add_user_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./add-user.component */ "./src/app/demo/user/add-user/add-user.component.ts");
...
let AddUserRoutingModule = class AddUserRoutingModule {
};
AddUserRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
let AddUserComponent = class AddUserComponent {
    constructor(formBuilder, user, router) {
        ...
        this.uploadAPI = `${_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiUrl}/user/update/image`;
        ...
        if (!this.addUserForm.invalid) {
            ...
            this.user.register(data).then(registerResponse => {
                ...
                if (registerResponse['status'] === 200) {
                    ...
                    sweetalert2__WEBPACK_IMPORTED_MODULE_7___default.a.fire('Error', `${registerResponse['message']}`, 'error');
                }
            });
        }
    }
...
AddUserComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./add-user.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/demo/user/add-user/add-user.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./add-user.component.scss */ "./src/app/demo/user/add-user/add-user.component.scss")).default]
    })
], AddUserComponent);
...
/* harmony import */ var _add_user_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./add-user-routing.module */ "./src/app/demo/user/add-user/add-user-routing.module.ts");
/* harmony import */ var _add_user_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./add-user.component */ "./src/app/demo/user/add-user/add-user.component.ts");
...
let AddUserModule = class AddUserModule {
};
AddUserModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [_add_user_component__WEBPACK_IMPORTED_MODULE_4__["AddUserComponent"]],
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
            _add_user_routing_module__WEBPACK_IMPORTED_MODULE_3__["AddUserRoutingModule"],
