...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["add-dispensary-add-dispensary-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppDemoDispensariesAddDispensaryAddDispensaryComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppDemoDispensariesAddDispensaryAddDispensaryRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "AddDispensaryRoutingModule", function () {
      return AddDispensaryRoutingModule;
    });
    /* harmony import */
    ...
    var _add_dispensary_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./add-dispensary.component */
    ...
    var AddDispensaryRoutingModule = function AddDispensaryRoutingModule() {
      _classCallCheck(this, AddDispensaryRoutingModule);
    };

    AddDispensaryRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppDemoDispensariesAddDispensaryAddDispensaryComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppDemoDispensariesAddDispensaryAddDispensaryComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "AddDispensaryComponent", function () {
      return AddDispensaryComponent;
    });
    /* harmony import */
    ...
    var AddDispensaryComponent =
    /*#__PURE__*/
    function () {
      function AddDispensaryComponent(router, dispensary, formBuilder, mapsAPILoader, ngZone) {
        _classCallCheck(this, AddDispensaryComponent);
      ...
      _createClass(AddDispensaryComponent, [{
        key: "ngOnInit",
        ...
        value: function setCurrentLocation() {
          ...
          if ('geolocation' in navigator) {
            navigator.geolocation.getCurrentPosition(function (position) {
              _this2.mapLatitude = position.coords.latitude;
              _this2.mapLongitude = position.coords.longitude;
              _this2.zoom = 8;
        ...
        key: "onAddDispensarySubmit",
        value: function onAddDispensarySubmit() {
          var _this4 = this;
          ...
          if (!this.addDispensaryForm.invalid) {
            ...
            this.dispensary.addDispensary(data).then(function (addResponse) {
              if (addResponse['status'] === 200) {
                  ...
                  _this4.uploader.onSuccessItem = function (item, response, status, headers) {
                    if (response) {
                      ...
                      if (formatedResponse['status'] === 200) {
                        sweetalert2__WEBPACK_IMPORTED_MODULE_8___default.a.fire('Success', "Dispensary Added Successfully", 'success').then(function (result) {
                          var admin = JSON.parse(localStorage.getItem('userInfo'));

                          if (admin.role === 1) {
                            _this4.router.navigateByUrl("/admin/dispensary/".concat(addResponse['data'].dispensaryId));
                          } else {
                            _this4.router.navigateByUrl('/admin/dispensary/profile');
                          }
                        });
                      }
                    }
                ...
                sweetalert2__WEBPACK_IMPORTED_MODULE_8___default.a.fire('Error', "".concat(addResponse['message']), 'error');
              }
            });
          }
        }
    ...
    AddDispensaryComponent.ctorParameters = function () {
      return [{
    ...
    AddDispensaryComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-add-dispensary',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./add-dispensary.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/demo/dispensaries/add-dispensary/add-dispensary.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./add-dispensary.component.scss */
      "./src/app/demo/dispensaries/add-dispensary/add-dispensary.component.scss")).default]
  ...
  /***/
  function srcAppDemoDispensariesAddDispensaryAddDispensaryModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "AddDispensaryModule", function () {
      return AddDispensaryModule;
    });
    /* harmony import */
    ...
    var _add_dispensary_routing_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./add-dispensary-routing.module */
    "./src/app/demo/dispensaries/add-dispensary/add-dispensary-routing.module.ts");
    /* harmony import */
    ...
    var AddDispensaryModule = function AddDispensaryModule() {
      _classCallCheck(this, AddDispensaryModule);
    };

    AddDispensaryModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      declarations: [_add_dispensary_component__WEBPACK_IMPORTED_MODULE_3__["AddDispensaryComponent"]],
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _add_dispensary_routing_module__WEBPACK_IMPORTED_MODULE_4__["AddDispensaryRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["ReactiveFormsModule"], _theme_shared_shared_module__WEBPACK_IMPORTED_MODULE_6__["SharedModule"], ng2_file_upload__WEBPACK_IMPORTED_MODULE_8__["FileUploadModule"], _sweetalert2_ngx_sweetalert2__WEBPACK_IMPORTED_MODULE_9__["SweetAlert2Module"], _agm_core__WEBPACK_IMPORTED_MODULE_7__["AgmCoreModule"].forRoot({
        apiKey: 'AIzaSyAcARFFtUPK8IeCXsVmh5I7CIw4hnxejqU',
        libraries: ['places']
      })]
    })], AddDispensaryModule); // AIzaSyDthHz_mCeEJPZIwRmxkSgjKYnEEkJgedk

    /***/
  }
}]);
//# sourceMappingURL=add-dispensary-add-dispensary-module-es5.js.map