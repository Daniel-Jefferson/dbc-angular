...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["payment-info-payment-info-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppDemoPaymentPaymentInfoPaymentInfoComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppDemoPaymentPaymentInfoPaymentInfoRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "PaymentInfoRoutingModule", function () {
      return PaymentInfoRoutingModule;
    });
    /* harmony import */
    ...
    var _payment_info_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    ...
    var PaymentInfoRoutingModule = function PaymentInfoRoutingModule() {
      _classCallCheck(this, PaymentInfoRoutingModule);
    };

    PaymentInfoRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppDemoPaymentPaymentInfoPaymentInfoComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppDemoPaymentPaymentInfoPaymentInfoComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "PaymentInfoComponent", function () {
    ...
    var _services_payment_payment_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    ...
    /*#__PURE__*/
    function () {
      function PaymentInfoComponent(formBuilder, payment, http) {
        _classCallCheck(this, PaymentInfoComponent);
      ...
      _createClass(PaymentInfoComponent, [{
        key: "ngOnInit",
          ...
          this.paymentForm = new SqPaymentForm({
            ...
            callbacks: {
              cardNonceResponseReceived: function cardNonceResponseReceived(errors, nonce, cardData) {
                ...
                document.getElementById('p-nonce').innerHTML = nonce; //(<HTMLInputElement>document.getElementById('sq-id')).value = "CBASEC8F-Phq5_pV7UNi64_kX_4gAQ";

                console.log(document.getElementById('p-nonce').innerHTML);
                document.getElementById('onFormSubmit').click(); //(<HTMLFormElement>document.getElementById('nonceform')).submit();
    ...
    PaymentInfoComponent.ctorParameters = function () {
      return [{
    ...
    PaymentInfoComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-payment-info',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./payment-info.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/demo/payment/payment-info/payment-info.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./payment-info.component.scss */
      "./src/app/demo/payment/payment-info/payment-info.component.scss")).default]
  ...
  /***/
  function srcAppDemoPaymentPaymentInfoPaymentInfoModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "PaymentInfoModule", function () {
      return PaymentInfoModule;
    });
    /* harmony import */
    ...
    var _payment_info_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./payment-info-routing.module */
    "./src/app/demo/payment/payment-info/payment-info-routing.module.ts");
    /* harmony import */


    var _payment_info_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./payment-info.component */
    "./src/app/demo/payment/payment-info/payment-info.component.ts");
    /* harmony import */
    ...
    var PaymentInfoModule = function PaymentInfoModule() {
      _classCallCheck(this, PaymentInfoModule);
    };

    PaymentInfoModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      declarations: [_payment_info_component__WEBPACK_IMPORTED_MODULE_4__["PaymentInfoComponent"]],
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _payment_info_routing_module__WEBPACK_IMPORTED_MODULE_3__["PaymentInfoRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["ReactiveFormsModule"]]
    })], PaymentInfoModule);
    /***/
  }
}]);
//# sourceMappingURL=payment-info-payment-info-module-es5.js.map